...
<head>
    ...
    <link rel="stylesheet" href="<?php echo ASSETS_BOOTSTRAP_PATH; ?>css/bootstrap.min.css" media="screen">
    <link rel="stylesheet" href="<?php echo ROOT_PATH; ?>css/osticket.css" media="screen">
	<link rel="stylesheet" href="<?php echo ASSETS_BOOTSTRAP_PATH; ?>css/bootstrap-theme.css" media="screen">
	...
	<script type="text/javascript" src="<?php echo ASSETS_BOOTSTRAP_PATH; ?>js/bootstrap.min.js"></script>
